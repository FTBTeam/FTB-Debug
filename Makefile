build/linux/arm64:
	...
	CGO_ENABLED=1 GOOS=linux GOARCH=arm64 wails build -o ftb-debug-linux-arm64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
...
build/windows/arm64:
	...
	CGO_ENABLED=1 GOOS=windows GOARCH=arm64 wails build -o ftb-debug-windows-arm64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
...
build/darwin/arm64:
	...
	CGO_ENABLED=1 GOOS=darwin GOARCH=arm64 wails build -o ftb-debug-darwin-amd64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
