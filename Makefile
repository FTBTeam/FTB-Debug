build/linux/arm64:
	...
	CGO_ENABLED=1 wails build --platform linux/arm64 -o ftb-debug-linux-arm64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
...
build/windows/arm64:
	...
	CGO_ENABLED=1 wails build --platform windows/arm64 -o ftb-debug-windows-arm64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
...
build/darwin/amd64:
	...
	CGO_ENABLED=1 wails build --platform darwin/arm64 -o ftb-debug-darwin-arm64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
...
build/darwin/arm64:
	...
	CGO_ENABLED=1 wails build --platform darwin/amd64 -o ftb-debug-darwin-amd64 -trimpath -ldflags "-s -w -X 'main.GitCommit=$(GITHUB_SHA_SHORT)' -X 'main.Version=$(GITHUB_REF_NAME)'"
